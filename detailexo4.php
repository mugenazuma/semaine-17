...
<?php
        if (isset($_GET["delete"]) && $_GET["delete"] == "error") {
            ?>
            <div class="alert alert-warning">Votre produit n'a pas été supprimé</div>
            <?php
        }
    ?>
...
<H1 align="center">Détail du produit</h1>
    ...
    <div class="container">
        ...
        <form class="choose" action="script_modification.php" method="POST" name="Détail produit" id="Détail produit">
        ...
        Produit bloqué&nbsp :
            ...
            <input type="button" name="Supprimer" value="Supprimer" onclick="self.location.href='suppression_prod.php?pro_id=<?=$produit->pro_id?>'" style="background-color:red" style="color:white; font-weight:bold"onclick>
        </div>
            <br>
